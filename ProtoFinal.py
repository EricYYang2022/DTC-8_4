...
def selectbutton(msg,x,y,w,h,ic,ac,typeof, action=None,act_arg=None):
    ...
    MontFont = pygame.font.Font('Montserrat-Regular.otf',20)
    textSurf, textRect = text_objects(msg, MontFont)
...
if __name__ == '__main__':
    while gameloop:
        ...
        largeText = pygame.font.Font('Montserrat-Regular.otf',80)
        smallText = pygame.font.Font('Montserrat-Regular.otf', 30)
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_w:
                    ...
                    if sum(final_list) == (diff - 1) and checker == 1:
                        reset_balance()
                    else:
                        loop_function(1)
